...
if(hasChanges){
  ...
  <div className="fixed z-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex items-center justify-center max-[600px]:px-4">
   ...
   {hasChanges && <button className="dark:bg-indigo-500 dark:hover:bg-indigo-400 bg-indigo-400 hover:bg-indigo-500 transition px-4 py-2 text-sm sm:text-base w-full sm:w-40 rounded-lg font-bold relative">Update User {isLoading &&  <span className="absolute ml-2 w-5 h-5 mr-2 border-2 border-white border-t-transparent rounded-full animate-spin"></span>}</button>}
