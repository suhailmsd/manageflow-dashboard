...
export default function AdminDashboard() {
  ...
  {hasRole('admin') ? <div className='h-16 border-dashed border flex items-center w-36 p-2'>
    <div className='font-mono text-md'>Role: <span className='text-sm'>{userDetails?.role}</span></div>
  </div> : ''}
