      ...
      <div className="fixed z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-74 max-sm:w-full max-sm:p-2 scale-125 max-[500px]:scale-75 max-xl:scale-100">
        <div className="w-full flex flex-col items-center h-44 justify-between p-3 rounded-lg shadow relative bg-gray-700 opacity-90 dark:bg-gray-600">
          <div className="mt-5">
            ...
            <button onClick={cancelModal} className="absolute top-2 right-2">
              <FaTimesCircle
          ...
          <div className="mb-2 w-full flex gap-2">
            <button
              ...
              className="bg-slate-100 hover:bg-white shadow py-2 rounded w-full text-gray-800 font-bold"
            >
              {confirmButtonTitle}
            </button>
            <button
              onClick={cancelModal}
              className="bg-red-600 hover:bg-red-500 shadow py-2 rounded w-full text-white font-bold"
            >
              Cancel
            </button>
          </div>
